<div class="modal micromodal-slide font-poppins" id="modal-item-visible" aria-hidden="true">
    <div class="modal__overlay" tabindex="-1" data-micromodal-close>
        <div class="modal__container rounded-none sm:rounded-md w-full h-full sm:h-auto sm:w-5/12 2xl:w-[510px] px-12 pt-8 pb-8" role="dialog" aria-modal="true" aria-labelledby="modal-1-title">
            <form method="POST" action="{{ url('admin/section') }}" class="flex flex-col justify-start items-start h-full sm:h-auto">
                ...
                <h5 class="text-lg mx-auto mb-12 sm:mb-5 text-gray-800">Ocultar Item</h5>
                <p class="m-5">Deseja <span id="item-visible"></span> o item <b id="item-name" class="text-pink-cherie underline"></b>?</p>
