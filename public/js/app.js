...
window.axios.defaults.headers.common['X-Requested-With'] = 'XMLHttpRequest'; // MicroModal.init({
//     disableScroll: true,
//     disableFocus: true
// });
// MicroModal.init({
...
var sectionOptions = document.querySelectorAll('li.section button');
var itemOptions = document.querySelectorAll('li.item button');
