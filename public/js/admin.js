...
var sectionVisible = function sectionVisible(section) {
  ...
  sweetalert2__WEBPACK_IMPORTED_MODULE_0___default().fire({
    ...
    focusConfirm: true,
    width: 500,
    html: "\n        <form method=\"POST\" action=\"".concat((0,_routes_js__WEBPACK_IMPORTED_MODULE_1__.route)('section.visible', [section.id]), "\" class=\"modal-form flex flex-col justify-start items-start h-full sm:h-auto\">\n            <input type=\"hidden\" value=\"").concat(csrf, "\" name=\"_token\">\n            <input type=\"hidden\" name=\"_method\" value=\"PUT\">\n\n            <p class=\"m-5\">Deseja ").concat(section.active == 1 ? 'ocultar' : 'exibir', " a se\xE7\xE3o <b class=\"text-pink-cherie selection:bg-pink-cherie selection:text-white underline\">").concat(section.name, "</b>?</p>\n        </form>\n        ")
  }).then(function (value) {
    if (value.isConfirmed) {
      var _form = document.querySelector('.modal-form');
...
var sectionDestroy = function sectionDestroy(section) {
  ...
  sweetalert2__WEBPACK_IMPORTED_MODULE_0___default().fire({
    ...
    focusConfirm: true,
    width: 500,
    html: "\n        <form method=\"POST\" action=\"".concat((0,_routes_js__WEBPACK_IMPORTED_MODULE_1__.route)('section.destroy', [section.id]), "\" class=\"modal-form flex flex-col justify-start items-start h-full sm:h-auto\">\n            <input type=\"hidden\" value=\"").concat(csrf, "\" name=\"_token\">\n            <input type=\"hidden\" name=\"_method\" value=\"DELETE\">\n\n            <p class=\"m-5\">Deseja remover a se\xE7\xE3o <b class=\"text-pink-cherie selection:bg-pink-cherie selection:text-white underline\">").concat(section.name, "</b>?</p>\n        </form>")
  }).then(function (value) {
    if (value.isConfirmed) {
      var _form2 = document.querySelector('.modal-form');
